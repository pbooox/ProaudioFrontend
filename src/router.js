    ...
    */
    children: [
      ...
      },
      {
        path: "products",
        component: () =>
          import(/* webpackChunkName: "dashboards" */ "./views/app/pages"),
        children:[
          {
            path: "type",
            name: "typeproducts",
            component: () =>
            import(/* webpackChunkName: "dashboards" */ "./views/app/product/Type"),
          },
          {
            path: "brand",
            name: "brand",
            component: () =>
            import(/* webpackChunkName: "dashboards" */ "./views/app/product/Brand"),
          },
          // {
          //   path: "/",
          //   name: "employees",
          //   component: () =>
          //   import(/* webpackChunkName: "dashboards" */ "./views/product/Type"),
          // }
        ]
      },
      {
        ...
        children:[
          {
            ...
            name: "users",
            component: () =>
            import(/* webpackChunkName: "dashboards" */ "./views/user/User"),
          },
          {
            path: "/",
            name: "employees",
            component: () =>
            import(/* webpackChunkName: "dashboards" */ "./views/app/employee/Employee"),
          }
        ]
      },
      {
        ...
        children:[
          ...
          // },
          {
            ...
            name: "customers",
            component: () =>
            import(/* webpackChunkName: "dashboards" */ "./views/app/customer/Customer"),
          }
        ]
      },
      {
        ...
        children:[
          ...
          // },
          {
            ...
            name: "providers",
            component: () =>
            import(/* webpackChunkName: "dashboards" */ "./views/app/provider/Provider"),
          }
        ]
      },
      // {
