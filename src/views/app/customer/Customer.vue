  ...
  methods: {
    ...
    onState() {
      ...
      if (this.form.state == 1) {
        axios
          .put(apiUrl + "/customers/deactivate", {
            id: this.form.id,
          })
          .then((response) => {
            me.$notify(
              "warning",
              "Desactivado",
              "Cliente " + this.form.name + " desactivado",
              { duration: 3000, permanent: false }
            );
            me.$refs.vuetable.refresh();
          })
        ...
        axios
          ...
          .then((response) => {
            me.$notify(
              "success",
              "Activado",
              "Cliente " + this.form.name + " activado",
              { duration: 3000, permanent: false }
            );
            me.$refs.vuetable.refresh();
          })
