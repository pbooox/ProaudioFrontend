<template>
  <div>
    ...
    <b-modal id="modal-des" title="Desactivar">
      <p class="my-4">
        ¿Desea desactivar el tipo: {{ form.name }} ?
      </p>
    ...
    <b-modal id="modal-react" title="Activar">
      <p class="my-4">
        ¿Desea activar el tipo: {{ form.name }} ?
      </p>
      <template #modal-footer="{}">
        <b-button
          size="sm"
    ...
    <b-modal
      ...
      id="modalSave"
      ref="modalSave"
      title="Registro de tipo de producto"
    >
      <b-form>
        <b-form-group label="Nombre:">
          <b-form-input
      ...
      axios.post(apiUrl + "/type/create", {
        ...
        .then((response) => {
          me.$notify(
            "primary filled",
            "Guardado",
            "Tipo de producto " + this.form.name + " guardado",
      ...
      axios
        ...
        .then((response) => {
          me.$notify(
            "secondary filled",
            "Actualizado",
            "Tipo de producto " + this.form.name + " actualizado",
            { duration: 3000, permanent: false }
          );
          me.$refs.vuetable.refresh();
          me.form.name = "";
        ...
        axios
          ...
          .then((response) => {
            me.$notify(
              "warning",
              "Desactivado",
              "Tipo de producto " + this.form.name + " desactivado",
              { duration: 3000, permanent: false }
            );
            me.$refs.vuetable.refresh();
          })
        ...
        axios
          ...
          .then((response) => {
            me.$notify(
              "success",
              "Activado",
              "Tipo de producto " + this.form.name + " activado",
              { duration: 3000, permanent: false }
            );
            me.$refs.vuetable.refresh();
          })
